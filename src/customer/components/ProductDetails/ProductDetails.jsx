...
import HomeSectionCard from "../HomrSectionCard/HomeSectionCard";
  ...
  return (
    <div className="bg-white lg:px-20">
      <div className="pt-6">
          ...
          <div className="lg:col-span-1 max-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="flex space-x-5 items-center text-lg lg:text-xl text-gray-900 mt-6">
                <p className="font-semibold">R199</p>
                <p className="opacity-50 line-through">R211</p>
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-50 teaxt-sm">56540 Rating</p>
        ...
        {/* Rating and Reviews */}
        <section>
      <h1 className="font-semibold text-lg pb-4"></h1>
